...
* `'EXP'.'type'`: `None` (nkululeko/data/dataset.py:146), `'classification'` (nkululeko/utils/util.py:298)
...
| 'DATA' | 'root_folders' | `False` | nkululeko/utils/util.py:71 |
...
| 'EXP' | 'run' | `0` | nkululeko/utils/util.py:218 |
...
| 'EXP' | 'type' | `'classification'` / `None` | nkululeko/data/dataset.py:146, nkululeko/utils/util.py:298 |
...
| 'FEATS' | 'nan_strategy' | `'zero'` | nkululeko/utils/util.py:362 |
...
| <section> | <key> | `str(default)` | nkululeko/utils/util.py:545 |
