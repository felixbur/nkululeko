...
_Auto-generated by `scripts/gen_defaults_table.py` from 496 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'MODEL'.'class_weight'`: `False` (nkululeko/models/model.py:279), `'False'` (nkululeko/models/model.py:303), `False` (nkululeko/models/model.py:318), `'auto'` (nkululeko/models/model_adm.py:93), `False` (nkululeko/models/model_xgb.py:137)
...
| 'EXP' | 'epochs' | `'50'` / `1` | nkululeko/modelrunner.py:165, nkululeko/models/model_tuned.py:66, nkululeko/optimizers/scheduler_factory.py:84 |
...
| 'FEATS' | 'balancing' | `False` | nkululeko/modelrunner.py:426 |
| 'FEATS' | 'balancing_random_state' | `42` | nkululeko/modelrunner.py:432 |
...
| 'FEATS' | 'emotion2vec.model' | `_MODEL_MAPPING.get(self.feats_type, 'emotion2vec/emotion2vec_plus_large')` / `model_mapping.get(self.feat_type, 'emotion2vec/emotion2vec_base')` | nkululeko/feat_extract/feats_emotion2vec.py:56, nkululeko/feat_extract/feats_emotion2vec_emotion.py:76 |
...
| 'MODEL' | 'class_weight' | `'False'` / `'auto'` / `False` | nkululeko/models/model.py:279, nkululeko/models/model.py:303, nkululeko/models/model.py:318, +2 more |
