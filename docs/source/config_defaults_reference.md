...
* `'EXP'.'sample_selection'`: `'all'` (nkululeko/data/datasplitter.py:36), `'train'` (nkululeko/experiment.py:476), `'all'` (nkululeko/experiment.py:497), `'all'` (nkululeko/feat_extract/feats_analyser.py:388), `'all'` (nkululeko/plots.py:636), `'all'` (nkululeko/predict.py:577), `'all'` (nkululeko/resample.py:123), `'all'` (nkululeko/segment.py:242)
* `'EXP'.'type'`: `None` (nkululeko/data/dataset.py:146), `'classification'` (nkululeko/utils/util.py:299)
...
* `'MODEL'.'batch_size'`: `32` (nkululeko/models/model_adm.py:190), `8` (nkululeko/models/model_cnn.py:71), `8` (nkululeko/models/model_mlp.py:79), `8` (nkululeko/models/model_mlp_regression.py:79), `'8'` (nkululeko/models/model_tuned.py:58)
...
* `'MODEL'.'loss'`: `'cross'` (nkululeko/models/model.py:93), `'bce'` (nkululeko/models/model_adm.py:65), `'mse'` (nkululeko/models/model_mlp_regression.py:35), `'cross'` (nkululeko/models/model_tuned.py:434), `'1-ccc'` (nkululeko/models/model_tuned.py:453)
* `'MODEL'.'measure'`: `'mse'` (nkululeko/models/model_mlp_regression.py:240), `'ccc'` (nkululeko/models/model_tuned.py:56), `'uar'` (nkululeko/reporting/reporter.py:82), `'mse'` (nkululeko/reporting/reporter.py:93), `'mse'` (nkululeko/reporting/reporter.py:656), `'uar'` (nkululeko/reporting/run_plotter.py:79), `'uar'` (nkululeko/runmanager.py:166), `'uar'` (nkululeko/utils/util.py:649), `'mse'` (nkululeko/utils/util.py:656)
...
| 'DATA' | 'bins' | `False` | nkululeko/data/dataset.py:529 |
...
| 'DATA' | 'labels' | `False` | nkululeko/data/dataset.py:805, nkululeko/experiment.py:134 |
...
| 'DATA' | 'size_diff_weight' | `'1'` | nkululeko/data/dataset.py:558 |
...
| 'EXP' | 'sample_selection' | `'all'` / `'train'` | nkululeko/data/datasplitter.py:36, nkululeko/experiment.py:476, nkululeko/experiment.py:497, +5 more |
...
| 'MODEL' | 'loss' | `'1-ccc'` / `'bce'` / `'cross'` / `'mse'` | nkululeko/models/model.py:93, nkululeko/models/model_adm.py:65, nkululeko/models/model_mlp_regression.py:35, +2 more |
...
| 'MODEL' | 'measure' | `'ccc'` / `'mse'` / `'uar'` | nkululeko/models/model_mlp_regression.py:240, nkululeko/models/model_tuned.py:56, nkululeko/reporting/reporter.py:82, +6 more |
...
| 'PLOT' | 'fps' | `'1'` | nkululeko/reporting/reporter.py:670 |
| 'PLOT' | 'kind' | `'violin'` | nkululeko/plots.py:786 |
| 'PLOT' | 'name' | `plot_name_suggest` | nkululeko/experiment.py:273, nkululeko/reporting/reporter.py:683, nkululeko/runmanager.py:100, +7 more |
...
| 'PLOT' | 'uncertainty_threshold' | `False` | nkululeko/reporting/reporter.py:303 |
...
| DATA.<self.name> | 'as_test' | `'False'` | nkululeko/data/dataset.py:381, nkululeko/data/dataset.py:502 |
| DATA.<self.name> | 'as_train' | `'False'` | nkululeko/data/dataset.py:384, nkululeko/data/dataset.py:506 |
...
| DATA.<self.name> | 'dev' | `False` | nkululeko/data/dataset.py:642 |
| DATA.<self.name> | 'dev_size' | `20` | nkululeko/data/dataset.py:678, nkululeko/data/dataset.py:704 |
| DATA.<self.name> | 'dev_tables' | `False` | nkululeko/data/dataset.py:461 |
...
| DATA.<self.name> | 'mapping' | `False` | nkululeko/data/dataset.py:787 |
| DATA.<self.name> | 'rename_speakers' | `False` | nkululeko/data/dataset.py:266 |
| DATA.<self.name> | 'required' | `False` | nkululeko/data/dataset.py:253 |
| DATA.<self.name> | 'reverse' | `'False'` | nkululeko/data/dataset.py:281 |
| DATA.<self.name> | 'reverse.max' | `'False'` | nkululeko/data/dataset.py:283 |
| DATA.<self.name> | 'scale' | `False` | nkululeko/data/dataset.py:292 |
| DATA.<self.name> | 'split_strategy' | `'speaker_split'` | nkululeko/data/dataset.py:304, nkululeko/data/dataset.py:409 |
| DATA.<self.name> | 'target_tables' | `False` | nkululeko/data/dataset.py:49 |
| DATA.<self.name> | 'test' | `False` | nkululeko/data/dataset.py:621, nkululeko/data/dataset.py:636 |
| DATA.<self.name> | 'test_size' | `20` | nkululeko/data/dataset.py:524, nkululeko/data/dataset.py:668, nkululeko/data/dataset.py:677, +2 more |
| DATA.<self.name> | 'test_tables' | `False` | nkululeko/data/dataset.py:57, nkululeko/data/dataset.py:326, nkululeko/data/dataset.py:447 |
| DATA.<self.name> | 'train' | `False` | nkululeko/data/dataset.py:627, nkululeko/data/dataset.py:648 |
| DATA.<self.name> | 'train_tables' | `False` | nkululeko/data/dataset.py:61, nkululeko/data/dataset.py:333, nkululeko/data/dataset.py:454 |
| DATA.<self.name> | 'value_counts' | `False` | nkululeko/data/dataset.py:730, nkululeko/data/dataset.py:747 |
