...
* `'EXP'.'epochs'`: `1` (nkululeko/modelrunner.py:129), `1` (nkululeko/models/model_tuned.py:62), `'50'` (nkululeko/optimizers/scheduler_factory.py:84)
...
| 'EXP' | 'epochs' | `'50'` / `1` | nkululeko/modelrunner.py:129, nkululeko/models/model_tuned.py:62, nkululeko/optimizers/scheduler_factory.py:84 |
