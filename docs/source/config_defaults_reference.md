...
_Auto-generated by `scripts/gen_defaults_table.py` from 484 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'FEATS'.'type'`: `['os']` (nkululeko/bundle.py:220), `'os'` (nkululeko/data/datasplitter.py:344), `['os']` (nkululeko/experiment.py:241), `['os']` (nkululeko/infer.py:208), `None` (nkululeko/predict.py:193), `None` (nkululeko/predict.py:747)
...
| 'DATA' | 'label_data' | `False` | nkululeko/experiment.py:754, nkululeko/testing_predictor.py:31 |
| 'DATA' | 'label_result' | `False` | nkululeko/experiment.py:755 |
| 'DATA' | 'labels' | `False` | nkululeko/data/dataset.py:783, nkululeko/experiment.py:134 |
...
| 'DATA' | 'sample_selection' | `'all'` | nkululeko/experiment.py:357 |
...
| 'EXPL' | 'pca' | `'False'` | nkululeko/experiment.py:649, nkululeko/explore.py:88 |
...
| 'EXPL' | 'print_colvals' | `'False'` | nkululeko/experiment.py:530 |
...
| 'EXPL' | 'scatter' | `'False'` | nkululeko/experiment.py:570, nkululeko/explore.py:89 |
| 'EXPL' | 'scatter.dim' | `2` | nkululeko/plots.py:633 |
| 'EXPL' | 'scatter.target' | `default_scatter_target` | nkululeko/experiment.py:582 |
| 'EXPL' | 'shap' | `'False'` | nkululeko/experiment.py:562, nkululeko/explore.py:90, nkululeko/flags.py:297 |
| 'EXPL' | 'spotlight' | `'False'` | nkululeko/experiment.py:537 |
| 'EXPL' | 'tsne' | `'False'` | nkululeko/experiment.py:629, nkululeko/explore.py:86 |
| 'EXPL' | 'umap' | `'False'` | nkululeko/experiment.py:639, nkululeko/explore.py:87 |
| 'EXPL' | 'value_counts' | `False` | nkululeko/experiment.py:528, nkululeko/plots.py:129 |
...
| 'FEATS' | 'scale' | `False` | nkululeko/bundle.py:221, nkululeko/demo_predictor.py:114, nkululeko/experiment.py:663, +2 more |
...
| 'FEATS' | 'type' | `'os'` / `None` / `['os']` | nkululeko/bundle.py:220, nkululeko/data/datasplitter.py:344, nkululeko/experiment.py:241, +3 more |
...
| 'PREDICT' | 'sample_selection' | `'all'` | nkululeko/experiment.py:387 |
| 'PREDICT' | 'target_language' | `'en'` | nkululeko/autopredict/ap_translate.py:25 |
| 'PREDICT' | 'targets' | `None` | nkululeko/experiment.py:399 |
...
| <section> | <key> | `str(default)` | nkululeko/utils/util.py:513 |
| <section> | <name> | `False` | nkululeko/utils/naming.py:37, nkululeko/utils/naming.py:38 |
| DATA.<d> | 'type' | `'audformat'` | nkululeko/experiment.py:107, nkululeko/experiment.py:184 |
