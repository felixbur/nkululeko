...
_Auto-generated by `scripts/gen_defaults_table.py` from 485 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
| 'MODEL' | 'device' | `'cpu'` / `False` / `cuda` / `device` | nkululeko/augmenting/augmenter_silero.py:30, nkululeko/autopredict/ap_sid.py:31, nkululeko/autopredict/ap_text.py:28, +32 more |
