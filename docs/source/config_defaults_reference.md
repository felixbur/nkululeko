...
_Auto-generated by `scripts/gen_defaults_table.py` from 477 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'MODEL'.'device'`: `'cpu'` (nkululeko/augmenting/augmenter_silero.py:36), `'cpu'` (nkululeko/autopredict/ap_sid.py:31), `device` (nkululeko/autopredict/ap_text.py:28), `cuda` (nkululeko/feat_extract/feats_agender.py:38), `cuda` (nkululeko/feat_extract/feats_agender_agender.py:36), `cuda` (nkululeko/feat_extract/feats_ast.py:19), `cuda` (nkululeko/feat_extract/feats_auddim.py:34), `cuda` (nkululeko/feat_extract/feats_audmodel.py:45), `cuda` (nkululeko/feat_extract/feats_audwav2vec2.py:38), `cuda` (nkululeko/feat_extract/feats_bert.py:22), `'cpu'` (nkululeko/feat_extract/feats_clap.py:17), `cuda` (nkululeko/feat_extract/feats_emotion2vec.py:31), `cuda` (nkululeko/feat_extract/feats_hubert.py:29), `cuda` (nkululeko/feat_extract/feats_lfcc.py:95), `'cpu'` (nkululeko/feat_extract/feats_mos.py:33), `cuda` (nkululeko/feat_extract/feats_spkrec.py:29), `cuda` (nkululeko/feat_extract/feats_sptk.py:39), `cuda` (nkululeko/feat_extract/feats_squim.py:36), `cuda` (nkululeko/feat_extract/feats_textclassifier.py:23), `cuda` (nkululeko/feat_extract/feats_wav2vec2.py:32), `cuda` (nkululeko/feat_extract/feats_wavlm.py:29), `cuda` (nkululeko/feat_extract/feats_whisper.py:19), `cuda` (nkululeko/models/model_adm.py:62), `cuda` (nkululeko/models/model_adm.py:510), `'cpu'` (nkululeko/models/model_cnn.py:49), `cuda` (nkululeko/models/model_cnn.py:232), `cuda` (nkululeko/models/model_cnn.py:249), `cuda` (nkululeko/models/model_mlp.py:45), `cuda` (nkululeko/models/model_mlp.py:271), `cuda` (nkululeko/models/model_mlp.py:304), `cuda` (nkululeko/models/model_mlp_regression.py:56), `'cpu'` (nkululeko/models/model_mlp_regression.py:261), `'cpu'` (nkululeko/models/model_mlp_regression.py:279), `False` (nkululeko/models/model_tuned.py:44), `'cpu'` (nkululeko/segmenting/seg_pyannote.py:38)
...
* `'MODEL'.'learning_rate'`: `'0.0001'` (nkululeko/models/model_tuned.py:62), `0.3` (nkululeko/models/model_xgb.py:32), `str(default_lr)` (nkululeko/optimizers/optimizer_factory.py:32)
...
| 'AUGMENT' | 'bypass_prob' | `0.3` | nkululeko/augmenting/augmenter_auglib.py:37 |
| 'AUGMENT' | 'crop_dur' | `1.0` | nkululeko/augmenting/augmenter_auglib.py:128 |
| 'AUGMENT' | 'p_reverse' | `'0.3'` | nkululeko/augmenting/randomsplicer.py:44 |
| 'AUGMENT' | 'result' | `'augmented.csv'` | nkululeko/augment.py:41 |
| 'AUGMENT' | 'silero_model' | `'small_slow'` | nkululeko/augmenting/augmenter_silero.py:35 |
| 'AUGMENT' | 'top_db' | `'12'` | nkululeko/augmenting/randomsplicer.py:45 |
| 'AUGMENT' | 'transformations' | `'["room", "music", "noise", "babble", "crop", "cough"]'` | nkululeko/augmenting/augmenter_auglib.py:29 |
...
| 'EXP' | 'runs' | `1` | nkululeko/experiment.py:733, nkululeko/reporting/run_plotter.py:43, nkululeko/runmanager.py:66 |
...
| 'MODEL' | 'device' | `'cpu'` / `False` / `cuda` / `device` | nkululeko/augmenting/augmenter_silero.py:36, nkululeko/autopredict/ap_sid.py:31, nkululeko/autopredict/ap_text.py:28, +32 more |
...
| 'MODEL' | 'max_duration' | `'8.0'` | nkululeko/models/model_tuned.py:64 |
| 'MODEL' | 'max_grad_norm' | `'0.0'` | nkululeko/models/model_adm.py:195 |
| 'MODEL' | 'measure' | `'ccc'` / `'mse'` / `'uar'` | nkululeko/models/model_mlp_regression.py:240, nkululeko/models/model_tuned.py:57, nkululeko/reporting/reporter.py:82, +6 more |
...
| 'MODEL' | 'pretrained_model' | `model_path` | nkululeko/models/model_tuned.py:79 |
| 'MODEL' | 'push_to_hub' | `'False'` | nkululeko/models/model_tuned.py:73 |
