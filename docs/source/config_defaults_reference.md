...
_Auto-generated by `scripts/gen_defaults_table.py` from 486 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'FINETUNE'.'loss'`: `'cross'` (nkululeko/models/finetune_config.py:143), `'1-ccc'` (nkululeko/models/finetune_config.py:146)
...
| 'FINETUNE' | 'balancing' | `False` | nkululeko/models/finetune_config.py:86 |
| 'FINETUNE' | 'batch_size' | `'8'` | nkululeko/models/finetune_config.py:78 |
| 'FINETUNE' | 'class_weight' | `False` | nkululeko/models/finetune_config.py:90 |
| 'FINETUNE' | 'device' | `False` | nkululeko/models/finetune_config.py:70 |
| 'FINETUNE' | 'drop' | `False` | nkululeko/models/finetune_config.py:82 |
| 'FINETUNE' | 'freeze_layers' | `0` | nkululeko/models/finetune_config.py:96 |
| 'FINETUNE' | 'head_activation' | `'tanh'` | nkululeko/models/finetune_config.py:121 |
| 'FINETUNE' | 'head_layers' | `False` | nkululeko/models/finetune_config.py:112 |
| 'FINETUNE' | 'learning_rate' | `'0.0001'` | nkululeko/models/finetune_config.py:79 |
| 'FINETUNE' | 'loss' | `'1-ccc'` / `'cross'` | nkululeko/models/finetune_config.py:143, nkululeko/models/finetune_config.py:146 |
| 'FINETUNE' | 'max_duration' | `'8.0'` | nkululeko/models/finetune_config.py:80 |
| 'FINETUNE' | 'measure' | `'ccc'` | nkululeko/models/finetune_config.py:147 |
| 'FINETUNE' | 'num_layers' | `False` | nkululeko/models/finetune_config.py:103 |
| 'FINETUNE' | 'pooling' | `'mean'` | nkululeko/models/finetune_config.py:128 |
| 'FINETUNE' | 'pretrained_model' | `'facebook/wav2vec2-large-robust-ft-swbd-300h'` | nkululeko/models/finetune_config.py:87 |
| 'FINETUNE' | 'push_to_hub' | `False` | nkululeko/models/finetune_config.py:85 |
| 'FINETUNE' | 'warmup_ratio' | `'0.0'` | nkululeko/models/finetune_config.py:138 |
