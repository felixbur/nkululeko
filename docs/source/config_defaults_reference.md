...
_Auto-generated by `scripts/gen_defaults_table.py` from 478 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'EXP'.'epochs'`: `1` (nkululeko/modelrunner.py:129), `1` (nkululeko/models/model_tuned.py:61), `'50'` (nkululeko/optimizers/scheduler_factory.py:84)
...
* `'FINETUNE'.'loss'`: `'cross'` (nkululeko/models/finetune_config.py:70), `'1-ccc'` (nkululeko/models/finetune_config.py:73)
...
| 'EXP' | 'epochs' | `'50'` / `1` | nkululeko/modelrunner.py:129, nkululeko/models/model_tuned.py:61, nkululeko/optimizers/scheduler_factory.py:84 |
...
| 'FINETUNE' | 'balancing' | `False` | nkululeko/models/finetune_config.py:55 |
| 'FINETUNE' | 'batch_size' | `'8'` | nkululeko/models/finetune_config.py:47 |
| 'FINETUNE' | 'class_weight' | `False` | nkululeko/models/finetune_config.py:59 |
| 'FINETUNE' | 'device' | `False` | nkululeko/models/finetune_config.py:39 |
| 'FINETUNE' | 'drop' | `False` | nkululeko/models/finetune_config.py:51 |
| 'FINETUNE' | 'freeze_layers' | `0` | nkululeko/models/finetune_config.py:65 |
| 'FINETUNE' | 'learning_rate' | `'0.0001'` | nkululeko/models/finetune_config.py:48 |
| 'FINETUNE' | 'loss' | `'1-ccc'` / `'cross'` | nkululeko/models/finetune_config.py:70, nkululeko/models/finetune_config.py:73 |
| 'FINETUNE' | 'max_duration' | `'8.0'` | nkululeko/models/finetune_config.py:49 |
| 'FINETUNE' | 'measure' | `'ccc'` | nkululeko/models/finetune_config.py:74 |
| 'FINETUNE' | 'pretrained_model' | `'facebook/wav2vec2-large-robust-ft-swbd-300h'` | nkululeko/models/finetune_config.py:56 |
| 'FINETUNE' | 'push_to_hub' | `False` | nkululeko/models/finetune_config.py:54 |
