...
_Auto-generated by `scripts/gen_defaults_table.py` from 482 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'DATA'.'target'`: `'emotion'` (nkululeko/augment.py:81), `'emotion'` (nkululeko/augmenting/resampler.py:76), `'emotion'` (nkululeko/bundle.py:56), `'emotion'` (nkululeko/bundle.py:218), `None` (nkululeko/data/dataset.py:34), `None` (nkululeko/data/dataset_csv.py:84), `None` (nkululeko/experiment.py:123), `'emotion'` (nkululeko/experiment.py:617), `'emotion'` (nkululeko/experiment.py:627), `'emotion'` (nkululeko/experiment.py:637), `'emotion'` (nkululeko/export.py:108), `'emotion'` (nkululeko/feat_extract/feats_analyser.py:26), `'emotion'` (nkululeko/models/model.py:34), `'emotion'` (nkululeko/plots.py:31), `'class_label'` (nkululeko/plots.py:893), `'emotion'` (nkululeko/testing_predictor.py:71), `None` (nkululeko/utils/util.py:606)
* `'DATA'.'tests'`: `'False'` (nkululeko/data/dataset.py:709), `False` (nkululeko/nkululeko.py:46), `False` (nkululeko/testing_predictor.py:59)
* `'DATA'.'type'`: `False` (nkululeko/data/dataset.py:801), `'dummy'` (nkululeko/data/datasplitter.py:242)
...
* `'EXP'.'sample_selection'`: `'all'` (nkululeko/data/datasplitter.py:32), `'train'` (nkululeko/experiment.py:476), `'all'` (nkululeko/experiment.py:497), `'all'` (nkululeko/feat_extract/feats_analyser.py:388), `'all'` (nkululeko/plots.py:636), `'all'` (nkululeko/predict.py:577), `'all'` (nkululeko/resample.py:127), `'all'` (nkululeko/segment.py:242)
* `'EXP'.'type'`: `None` (nkululeko/data/dataset.py:145), `'classification'` (nkululeko/utils/util.py:297)
...
* `'FEATS'.'type'`: `['os']` (nkululeko/bundle.py:220), `'os'` (nkululeko/data/datasplitter.py:416), `['os']` (nkululeko/experiment.py:227), `['os']` (nkululeko/infer.py:208), `None` (nkululeko/predict.py:215), `None` (nkululeko/predict.py:911)
...
| 'DATA' | 'balance' | `False` | nkululeko/data/dataset.py:523 |
| 'DATA' | 'bins' | `False` | nkululeko/data/dataset.py:513 |
...
| 'DATA' | 'label_data' | `False` | nkululeko/experiment.py:740, nkululeko/testing_predictor.py:31 |
| 'DATA' | 'label_result' | `False` | nkululeko/experiment.py:741 |
| 'DATA' | 'labels' | `False` | nkululeko/data/dataset.py:789, nkululeko/experiment.py:134 |
...
| 'DATA' | 'no_reuse' | `'False'` | nkululeko/augment.py:43, nkululeko/data/datasplitter.py:112, nkululeko/experiment.py:161 |
| 'DATA' | 'root_folders' | `False` | nkululeko/utils/util.py:70 |
| 'DATA' | 'sample_selection' | `'all'` | nkululeko/experiment.py:343 |
| 'DATA' | 'size_diff_weight' | `'1'` | nkululeko/data/dataset.py:542 |
...
| 'DATA' | 'target_divide_by' | `False` | nkululeko/data/datasplitter.py:317 |
| 'DATA' | 'tests' | `'False'` / `False` | nkululeko/data/dataset.py:709, nkululeko/nkululeko.py:46, nkululeko/testing_predictor.py:59 |
| 'DATA' | 'trains' | `False` | nkululeko/utils/naming.py:52 |
| 'DATA' | 'type' | `'dummy'` / `False` | nkululeko/data/dataset.py:801, nkululeko/data/datasplitter.py:242 |
| 'DATA' | <f'{stratif_var}_bins'> | `False` | nkululeko/data/dataset.py:535 |
...
| 'EXP' | 'filter.sample_selection' | `'all'` | nkululeko/data/datasplitter.py:200 |
...
| 'EXP' | 'runs' | `1` | nkululeko/experiment.py:729, nkululeko/reporting/run_plotter.py:43, nkululeko/runmanager.py:66 |
| 'EXP' | 'sample_selection' | `'all'` / `'train'` | nkululeko/data/datasplitter.py:32, nkululeko/experiment.py:476, nkululeko/experiment.py:497, +5 more |
| 'EXP' | 'save' | `True` | nkululeko/experiment.py:706 |
| 'EXP' | 'save_test' | `False` | nkululeko/experiment.py:716 |
| 'EXP' | 'traindevtest' | `'False'` | nkululeko/experiment.py:54, nkululeko/models/model_xgb.py:74, nkululeko/runmanager.py:59 |
| 'EXP' | 'type' | `'classification'` / `None` | nkululeko/data/dataset.py:145, nkululeko/utils/util.py:297 |
...
| 'EXPL' | 'print_colvals' | `'False'` | nkululeko/experiment.py:516 |
...
| 'EXPL' | 'scatter' | `'False'` | nkululeko/experiment.py:556, nkululeko/explore.py:89 |
| 'EXPL' | 'scatter.dim' | `2` | nkululeko/plots.py:633 |
| 'EXPL' | 'scatter.target' | `default_scatter_target` | nkululeko/experiment.py:568 |
| 'EXPL' | 'shap' | `'False'` | nkululeko/experiment.py:548, nkululeko/explore.py:90, nkululeko/flags.py:297 |
| 'EXPL' | 'spotlight' | `'False'` | nkululeko/experiment.py:523 |
| 'EXPL' | 'tsne' | `'False'` | nkululeko/experiment.py:615, nkululeko/explore.py:86 |
| 'EXPL' | 'umap' | `'False'` | nkululeko/experiment.py:625, nkululeko/explore.py:87 |
| 'EXPL' | 'value_counts' | `False` | nkululeko/experiment.py:514, nkululeko/plots.py:129 |
...
| 'FEATS' | 'scale' | `False` | nkululeko/bundle.py:221, nkululeko/experiment.py:649, nkululeko/predict.py:918, +1 more |
...
| 'FEATS' | 'type' | `'os'` / `None` / `['os']` | nkululeko/bundle.py:220, nkululeko/data/datasplitter.py:416, nkululeko/experiment.py:227, +3 more |
...
| 'PLOT' | 'combine_per_speaker' | `False` | nkululeko/experiment.py:721 |
...
| 'PLOT' | 'name' | `plot_name_suggest` | nkululeko/experiment.py:273, nkululeko/reporting/reporter.py:663, nkululeko/runmanager.py:100, +7 more |
...
| 'PREDICT' | 'sample_selection' | `'all'` | nkululeko/experiment.py:373 |
| 'PREDICT' | 'target_language' | `'en'` | nkululeko/autopredict/ap_translate.py:25 |
| 'PREDICT' | 'targets' | `None` | nkululeko/experiment.py:385 |
...
| DATA.<self.name> | '' | `''` | nkululeko/data/dataset.py:67, nkululeko/data/dataset_csv.py:21 |
| DATA.<self.name> | 'absolute_path' | `'True'` | nkululeko/data/dataset_csv.py:49 |
| DATA.<self.name> | 'as_test' | `'False'` | nkululeko/data/dataset.py:365, nkululeko/data/dataset.py:486 |
| DATA.<self.name> | 'as_train' | `'False'` | nkululeko/data/dataset.py:368, nkululeko/data/dataset.py:490 |
| DATA.<self.name> | 'audio_path' | `'./'` | nkululeko/data/dataset_csv.py:26 |
| DATA.<self.name> | 'colnames' | `False` | nkululeko/data/dataset.py:76, nkululeko/data/dataset.py:86, nkululeko/data/dataset_csv.py:44 |
| DATA.<self.name> | 'columns' | `False` | nkululeko/data/dataset.py:102 |
| DATA.<self.name> | 'dev' | `False` | nkululeko/data/dataset.py:626 |
| DATA.<self.name> | 'dev_size' | `20` | nkululeko/data/dataset.py:662, nkululeko/data/dataset.py:688 |
| DATA.<self.name> | 'dev_tables' | `False` | nkululeko/data/dataset.py:445 |
| DATA.<self.name> | 'files_tables' | `False` | nkululeko/data/dataset.py:52 |
| DATA.<self.name> | 'label' | `self.target` | nkululeko/data/dataset.py:164, nkululeko/data/dataset.py:202 |
| DATA.<self.name> | 'limit' | `0` | nkululeko/data/dataset.py:36 |
| DATA.<self.name> | 'mapping' | `False` | nkululeko/data/dataset.py:771 |
| DATA.<self.name> | 'rename_speakers' | `False` | nkululeko/data/dataset.py:250 |
| DATA.<self.name> | 'required' | `False` | nkululeko/data/dataset.py:237 |
| DATA.<self.name> | 'reverse' | `'False'` | nkululeko/data/dataset.py:265 |
| DATA.<self.name> | 'reverse.max' | `'False'` | nkululeko/data/dataset.py:267 |
| DATA.<self.name> | 'scale' | `False` | nkululeko/data/dataset.py:276 |
| DATA.<self.name> | 'split_strategy' | `'speaker_split'` | nkululeko/data/dataset.py:288, nkululeko/data/dataset.py:393 |
| DATA.<self.name> | 'target_tables' | `False` | nkululeko/data/dataset.py:48 |
| DATA.<self.name> | 'test' | `False` | nkululeko/data/dataset.py:605, nkululeko/data/dataset.py:620 |
| DATA.<self.name> | 'test_size' | `20` | nkululeko/data/dataset.py:508, nkululeko/data/dataset.py:652, nkululeko/data/dataset.py:661, +2 more |
| DATA.<self.name> | 'test_tables' | `False` | nkululeko/data/dataset.py:56, nkululeko/data/dataset.py:310, nkululeko/data/dataset.py:431 |
| DATA.<self.name> | 'train' | `False` | nkululeko/data/dataset.py:611, nkululeko/data/dataset.py:632 |
| DATA.<self.name> | 'train_tables' | `False` | nkululeko/data/dataset.py:60, nkululeko/data/dataset.py:317, nkululeko/data/dataset.py:438 |
| DATA.<self.name> | 'value_counts' | `False` | nkululeko/data/dataset.py:714, nkululeko/data/dataset.py:731 |
