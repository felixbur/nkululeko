...
_Auto-generated by `scripts/gen_defaults_table.py` from 479 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'EXP'.'epochs'`: `1` (nkululeko/modelrunner.py:129), `1` (nkululeko/models/model_tuned.py:63), `'50'` (nkululeko/optimizers/scheduler_factory.py:84)
...
* `'FINETUNE'.'loss'`: `'cross'` (nkululeko/models/finetune_config.py:104), `'1-ccc'` (nkululeko/models/finetune_config.py:107)
...
| 'EXP' | 'epochs' | `'50'` / `1` | nkululeko/modelrunner.py:129, nkululeko/models/model_tuned.py:63, nkululeko/optimizers/scheduler_factory.py:84 |
...
| 'FINETUNE' | 'balancing' | `False` | nkululeko/models/finetune_config.py:81 |
| 'FINETUNE' | 'batch_size' | `'8'` | nkululeko/models/finetune_config.py:73 |
| 'FINETUNE' | 'class_weight' | `False` | nkululeko/models/finetune_config.py:85 |
| 'FINETUNE' | 'device' | `False` | nkululeko/models/finetune_config.py:65 |
| 'FINETUNE' | 'drop' | `False` | nkululeko/models/finetune_config.py:77 |
| 'FINETUNE' | 'freeze_layers' | `0` | nkululeko/models/finetune_config.py:91 |
| 'FINETUNE' | 'learning_rate' | `'0.0001'` | nkululeko/models/finetune_config.py:74 |
| 'FINETUNE' | 'loss' | `'1-ccc'` / `'cross'` | nkululeko/models/finetune_config.py:104, nkululeko/models/finetune_config.py:107 |
| 'FINETUNE' | 'max_duration' | `'8.0'` | nkululeko/models/finetune_config.py:75 |
| 'FINETUNE' | 'measure' | `'ccc'` | nkululeko/models/finetune_config.py:108 |
| 'FINETUNE' | 'num_layers' | `False` | nkululeko/models/finetune_config.py:98 |
| 'FINETUNE' | 'pretrained_model' | `'facebook/wav2vec2-large-robust-ft-swbd-300h'` | nkululeko/models/finetune_config.py:82 |
| 'FINETUNE' | 'push_to_hub' | `False` | nkululeko/models/finetune_config.py:80 |
