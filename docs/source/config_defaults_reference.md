...
_Auto-generated by `scripts/gen_defaults_table.py` from 490 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
| 'DATA' | 'balance' | `False` | nkululeko/data/dataset.py:561 |
| 'DATA' | 'bins' | `False` | nkululeko/data/dataset.py:551 |
...
| DATA.<self.name> | 'as_test' | `'False'` | nkululeko/data/dataset.py:387, nkululeko/data/dataset.py:524 |
| DATA.<self.name> | 'as_train' | `'False'` | nkululeko/data/dataset.py:390, nkululeko/data/dataset.py:528 |
...
| DATA.<self.name> | 'dev' | `False` | nkululeko/data/dataset.py:664 |
| DATA.<self.name> | 'dev_size' | `20` | nkululeko/data/dataset.py:700, nkululeko/data/dataset.py:726 |
| DATA.<self.name> | 'dev_tables' | `False` | nkululeko/data/dataset.py:65, nkululeko/data/dataset.py:467 |
...
| DATA.<self.name> | 'test_size' | `20` | nkululeko/data/dataset.py:546, nkululeko/data/dataset.py:690, nkululeko/data/dataset.py:699, +2 more |
