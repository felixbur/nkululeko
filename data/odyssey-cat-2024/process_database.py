...
df_test.columns = ['Split_Set', 'FileName']
df_test.to_csv('odyssey_test.csv', columns=['FileName', 'Split_Set'], index=False)

# Save the processed data to a new CSV file
# df_final.to_csv('processed_labels.csv', index=False)

print("Processing complete. New file saved as 'odyssey_<partition>.csv'")